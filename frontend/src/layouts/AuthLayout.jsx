...
function AuthLayout({ title, subtitle, footer, children }) {
  return (
    <main className="liquid-shell px-4 py-8 text-slate-100 sm:px-6 lg:grid lg:grid-cols-2 lg:p-0">
      <section className="mx-auto flex w-full max-w-md flex-col justify-center py-8 lg:py-16">
        <Link className="mb-12 inline-flex items-center gap-3 text-lg font-semibold tracking-tight" to="/">
          <span className="glass-action grid size-9 place-items-center rounded-xl bg-cyan-300 font-black text-slate-950">TW</span>
          ThreatWatch <span className="font-normal text-slate-400">OT</span>
        </Link>
        <div className="glass-panel rounded-3xl border p-6 sm:p-8">
      ...
      <aside className="relative hidden overflow-hidden border-l border-white/10 bg-slate-950/25 lg:flex lg:flex-col lg:justify-end lg:p-16">
